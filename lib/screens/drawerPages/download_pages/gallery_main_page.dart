      ...
      builder: (context, provider, child) {
        ...
        return Scaffold(
          ...
          body: GridView.builder(
            ...
            itemCount:
                provider.loadingThumbnails ? 13 : provider.thumbnails.length,
                    ...
                    children: [
                      GestureDetector(
                        onTap: !provider.loadingThumbnails
                            ? () {
                                provider.getGalleryDetails(
                                    thumbnail.header!.split(' ').join('-'));
                                Get.to(
                                    GalleryDetailsPage(thumbnail: thumbnail));
                              }
                            : null,
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: !provider.loadingThumbnails
                                ? CachedNetworkImage(
                                    imageUrl: thumbnail.defaultImage ?? '',
                                    fit: BoxFit.fill,
